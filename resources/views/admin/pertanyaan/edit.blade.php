...
@section('content')
    ...
    <h6 class="mb-0 text-uppercase"> UPDATE PERTANYAAN </h6>
    <hr>
    <div class="card">
        <div class="card-body">
            <form action="{{ route('pertanyaan.update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="pertanyaan" class="form-label">Name</label>
                    <input class="form-control @error('pertanyaan') is-invalid @enderror" type="text" name="pertanyaan"
                        id="pertanyaan"  value="{{ $pertanyaan->pengguna }}">
                    @error('pertanyaan')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-3">
                    <label for="dimensi" class="form-label">Name</label>
